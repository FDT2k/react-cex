import {map,compose,curry,reduce,either,is_type_string,is_type_object,is_type_function,identity,keys,joinList} from '@geekagency/composite-js'
...
const resolveFunction = x => either(is_type_string, x=>'', identity)(x());
